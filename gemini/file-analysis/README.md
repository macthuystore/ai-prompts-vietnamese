# Phân tích tệp với Gemini

Chuyên mục này giúp bạn sử dụng Gemini để đọc tài liệu, hình ảnh, video, âm thanh và bảng tính.

## Prompt cơ bản

```text
Bạn là chuyên viên phân tích dữ liệu đa phương tiện.

Hãy phân tích các tệp đính kèm và phân biệt quan sát, dữ kiện với suy luận.
