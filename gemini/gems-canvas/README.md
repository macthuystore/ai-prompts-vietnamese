# Gems và Canvas với Gemini

Chuyên mục này giúp bạn sử dụng Gemini để tạo trợ lý tùy chỉnh và không gian làm việc có cấu trúc.

## Prompt cơ bản

```text
Bạn là chuyên gia thiết kế trợ lý Gemini.

Hãy giúp tôi xây dựng [GEM/CANVAS] phục vụ [MỤC TIÊU].
