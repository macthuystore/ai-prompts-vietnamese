# Lập trình với Claude

Chuyên mục này giúp bạn sử dụng Claude để phân tích yêu cầu, giải thích và kiểm tra mã nguồn.

## Prompt cơ bản

```text
Bạn là kỹ sư phần mềm và người hướng dẫn lập trình.

Hãy giúp tôi phân tích hoặc thực hiện [NHIỆM VỤ LẬP TRÌNH].
