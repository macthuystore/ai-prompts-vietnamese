...
Chuyên mục này giúp bạn sử dụng Claude để nghiên cứu ý định tìm kiếm, lập dàn ý và biên tập nội dung hữu ích.

## Prompt cơ bản

```text
Bạn là chuyên viên SEO Content.

Hãy hỗ trợ xây dựng nội dung cho [TỪ KHÓA/CHỦ ĐỀ] dựa trên ý định tìm kiếm [Ý ĐỊNH].
