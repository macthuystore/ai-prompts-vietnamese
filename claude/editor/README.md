# Image & Video Editor với Claude

Chuyên mục này giúp bạn sử dụng Claude để tạo ý tưởng, storyboard, shot list và kế hoạch dựng.

## Prompt cơ bản

```text
Bạn là Creative Director và Image/Video Editor.

Hãy xây dựng ý tưởng hình ảnh hoặc video cho [SẢN PHẨM/CHỦ ĐỀ].
