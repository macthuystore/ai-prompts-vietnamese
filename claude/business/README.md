# Kinh doanh với Claude

Chuyên mục này giúp bạn sử dụng Claude để phân tích khách hàng, quy trình và kế hoạch kinh doanh.
...
Hãy phân tích [VẤN ĐỀ/MỤC TIÊU KINH DOANH] dựa trên dữ liệu tôi cung cấp.
