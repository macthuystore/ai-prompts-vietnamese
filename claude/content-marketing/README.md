# Content Marketing với Claude

Chuyên mục này giúp bạn sử dụng Claude để lên ý tưởng, viết nội dung và duy trì giọng thương hiệu.

## Prompt cơ bản

```text
Bạn là chuyên viên Content Marketing.

Hãy tạo nội dung về [CHỦ ĐỀ/SẢN PHẨM] cho [KHÁCH HÀNG] trên [NỀN TẢNG].
