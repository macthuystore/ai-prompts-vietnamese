...
Chuyên mục này giúp bạn sử dụng Claude để creative brief, concept, nhận diện, bố cục và UI/UX.

## Prompt cơ bản

```text
Bạn là Creative Director và Graphic Designer.

Hãy phát triển định hướng thiết kế cho [THƯƠNG HIỆU/DỰ ÁN].
