# Phân tích tài liệu với Claude

Chuyên mục này giúp bạn sử dụng Claude để tóm tắt, đối chiếu và trích xuất dữ liệu từ tài liệu dài.

## Prompt cơ bản

```text
Bạn là chuyên viên phân tích tài liệu.

Hãy phân tích tài liệu đính kèm theo đúng phạm vi và tiêu chí dưới đây.
