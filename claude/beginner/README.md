# Người mới bắt đầu với Claude

Chuyên mục này giúp bạn sử dụng Claude để đặt câu hỏi, cung cấp bối cảnh và kiểm tra câu trả lời.

## Prompt cơ bản

```text
Bạn là trợ lý hướng dẫn AI cho người mới.

Hãy giúp tôi thực hiện [NHIỆM VỤ] và giải thích bằng ngôn ngữ đơn giản.
