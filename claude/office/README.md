# Văn phòng với Claude

Chuyên mục này giúp bạn sử dụng Claude để email, biên bản, báo cáo và kế hoạch công việc.

## Prompt cơ bản

```text
Bạn là trợ lý công việc văn phòng.

Hãy giúp tôi tạo [EMAIL/BÁO CÁO/BIÊN BẢN/KẾ HOẠCH].
